...
import com.mob10.deliveryapp.ui.customer.ClientHomeScreen
import com.mob10.deliveryapp.ui.customer.CreateRequestScreen
import com.mob10.deliveryapp.ui.customer.CreateRequestViewModel
import com.mob10.deliveryapp.ui.customer.OrderConfirmationScreen
import com.mob10.deliveryapp.ui.customer.OrderTrackingScreen
import com.mob10.deliveryapp.ui.customer.OrderViewModel
import com.mob10.deliveryapp.ui.customer.OrderViewModelFactory
...
fun ClientFeatureFlow(currentUser: UserEntity, onLogout: () -> Unit) {
    ...
    val requestViewModel: CreateRequestViewModel = viewModel(
        key = "client_request_${currentUser.id}", factory = com.mob10.deliveryapp.ui.customer.CreateRequestViewModelFactory()
    )
